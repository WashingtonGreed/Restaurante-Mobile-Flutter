...
import 'package:restaurantemobileflutter/style/theme.dart' as Theme;
import 'package:restaurantemobileflutter/utils/bubble_indication_painter.dart';
...
class _LoginPageState extends State<LoginPage>
  ...
  TextEditingController recoverEmailController = new TextEditingController();
              ...
              child: FlatButton(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      ...
                      fontFamily: Theme.FontFamily.WorkSansSemiBold),
                ),
              ),
            ),
            ...
            child: FlatButton(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      ...
                      color: Colors.white,
                      fontSize: Theme.FontSize.medium,
                      fontFamily: Theme.FontFamily.WorkSansMedium),
                )),
          ),
          Padding(
            padding: EdgeInsets.only(top: 10.0),
  ...
  void _navigationBar({Usuario usuario}) {
    Navigator.push(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: TextField(
                ...
                decoration:
                    InputDecoration(hintText: "Informe seu E-mail de acesso"),
                style: new TextStyle(
                  fontFamily: Theme.FontFamily.WorkSansSemiBold,
            ...
            actions: <Widget>[
              ...
              new FlatButton(
                ...
                onPressed: () async {
                  Navigator.of(context).pop();
                  const controller = 'usuarios/ResetPasswordByEmail';
